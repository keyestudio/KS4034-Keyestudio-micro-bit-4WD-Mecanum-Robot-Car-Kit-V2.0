...
Secondly, if the red LED on the back of the board is on, that means th oard is powered. When your computer communicates with the main boar ia the USB cable, the yellow LED on it will flashes. For example, i ill flicker when you burn a “hex”file.
