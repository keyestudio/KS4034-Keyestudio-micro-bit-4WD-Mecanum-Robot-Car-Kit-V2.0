...
If the way you operate is correct, maybe you accidentally press the reset 
...
2\. After the latest firmware is downloaded, then drag it into the “MAINTENANCE”driver as follows, which makes Micro:bit come back to normal mode.

![](media/b56c4e3b30ae304a2fe9e8437afc2d9a.jpeg)

**How to avoid entering“MAINTENANCE”mode?**

Make sure the Reset button is not pressed when plugging the board via an USB cable.

![](media/d7ff1b51adb1f6b4500dc6a5af30a4fc.png)

2\. Don't unplug the cable suddenly during downloading micro:bit program, otherwise, the firmware will be lost and enter in“MAINTENANCE”mode .
