...
**Download Mu：** [https://codewith.mu/en/download](https://codewith.mu/en/download)
...
Enter the link: [https://codewith.mu/en/download](https://codewith.mu/en/download) to download th orresponding version of Mu.
...
![Img](./media/img-20250512145240.png)

In this tutorial, "keyes_mecanum_Car_V2.py" library file are used. Therefore, import the "keyes_mecanum_Car_V2.py" library file into the micro:bit. This file contains the control method of th icro:bit Mini Smart Mecanum Wheel Smart Car.
...
![Img](./media/img-20250512150224.png)

![Img](./media/img-20250512150252.png)

Open “mu_code”.

![Img](./media/img-20250512150313.png)

The path of the data folder where the “keyes_mecanum_Car.py“library file we provide are located is as follows:

![Img](./media/img-20250512150826.png)
...
First open the Mu software and connect the micro:bit to your computer hen click the "Files" button, and drag the "keyes_mecanum_Car.py" library file to the micro:bit.
...
![Img](./media/img-20250513134158.png)
...
![Img](./media/img-20250513134324.png)

The LED dot matrix shows the pattern “❤”and then “![](./media/04fdfc9060943954e7938bb1a741d626.png)”alternatively.
...
![Img](./media/img-20250512155027.png)
...
We will find that the 5*5 dot matrix start to show a downward arrow ![](./media/d4e278da768e447ed344d581e671f57a.png).
...
We will find that the 5*5 dot matrix start to show numbers 1,2,3,4 and 5 and then it alternatively shows a downward arrow word![](./media/d4e278da768e447ed344d581e671f57a.png),“Hello”, a heart pattern ![](./media/9b18b2b8dfaa0533d8859d08ff12611e.png), a rrow pointing at northeast ![](./media/364f2e355d6c354155b2e6db80830a62.png), then at southeast
![](./media/fb3ba009a20245ab6076e537159a229c.png) then at southwest ![](./media/7ec21961398787ca5155f0648bbd82cc.png) and then at northwest ![](./media/ced0bb410c8269205fe18554aa2c9926.png).

7\.  **Code Explanation**

![Img](./media/img-20250512155738.png)
...
![Img](./media/img-20250512160341.png)

![Img](./media/img-20250512160416.png)
...
![Img](./media/img-20250513134324.png)
 ...
 When the ambient temperature is less than 35℃, the 5*5 LED dot matrix shows ![](./media/4b1765e12b413dc5d562f2a16d32392f.png). When the temperature is equivalent to or greater than 35℃, the pattern ![](./media/f2705fbc4886efcfaac96589ca255f66.png) appears.

7\.  **Code Explanation**

![Img](./media/img-20250512160908.png)
...
![Img](./media/img-20250512163258.png)
...
![Img](./media/img-20250512164026.png)

![Img](./media/img-20250512164040.png)
...
![Img](./media/img-20250512164836.png)
...
![Img](./media/img-20250512165225.png)
...
![Img](./media/img-20250512170021.png)
...
![](./media/18c70cf16dcf8c9694a1af8b12530cf9.png)A
...
![Img](./media/img-20250512170309.png)
...
![Img](./media/img-20250513084928.png)
...
![Img](./media/img-20250513085728.png)
...
![](./media/232ea759b16ab27e7daff5da721c8e0c.jpg)
...
![Img](./media/img-20250513090853.png)

![Img](./media/img-20250513090915.png)
...
![Img](./media/img-20250513091339.png)
...
![Img](./media/img-20250513091511.png)
...
![Img](./media/img-20250513091617.png)
...
![Img](./media/img-20250513092316.png)

![Img](./media/img-20250513092417.png)
...
Click“Files”to import“keyes_mecanum_Car_V2.py“library file to micro:bit (How to import files? ). 
...
![Img](./media/img-20250513092923.png)
...
![Img](./media/img-20250513093037.png)
...
![Img](./media/img-20250513093456.png)

![Img](./media/img-20250513093559.png)
...
![Img](./media/img-20250513093734.png)
...
![Img](./media/img-20250513094058.png)

![Img](./media/img-20250513094159.png)
